...
namespace Math
{
	...
	public:
		...
		/// <summary>
		/// Decomposes the matrix into a rotation matrix, a translation vector and the scale factors.
		/// </summary>
		/// <param name="rotation">The rotation.</param>
		/// <param name="translation">The translation.</param>
		/// <param name="scale">The scale.</param>
		void decomposeTRS(Vector<Float, 3> & translation, Matrix4x4 & rotation, Vector<Float, 3> & scale)
		{
			translation[0] = (*this)(3, 0);
			translation[1] = (*this)(3, 1);
			translation[2] = (*this)(3, 2);
			scale[0] = getColumn(0).norm();
			scale[1] = getColumn(1).norm();
			scale[2] = getColumn(2).norm();
			rotation = (*this);
			rotation.setColumn(makeVector(Float(0.0), Float(0.0), Float(0.0), Float(1.0)), 3);
			rotation.setColumn(rotation.getColumn(0) / scale[0], 0);
			rotation.setColumn(rotation.getColumn(1) / scale[1], 0);
			rotation.setColumn(rotation.getColumn(2) / scale[2], 0);
		}

		///////////////////////////////////////////////////////////////////////////////////
		/// \brief Creates a translation matrix in homogeneous coordinates.
		/// 
		/// \param trans The translation vector (3D)
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		static Matrix4x4 getNormalTransform(Matrix4x4 transformVertex)
		{
			const Float zero(0.0);
			const Float one(1.0);
			transformVertex.setColumn(Math::makeVector(zero, zero, zero, one), 3);
